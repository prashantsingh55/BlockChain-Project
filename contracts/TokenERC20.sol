...
contract TokenERC20 {
    ...
    // This creats an array with all balances
    ...
    function _transfer(
        ...
        //Save this for an assertation in the future
        uint256 previousBalances = balanceOf[_from] + balanceOf[_to];

        //Subtract from the sender
        balanceOf[_from] -= _value;

        //Add same to recepient
    ...
    /**
      ...
      Allows `_spender` to send no more than `_value` tokens on  your behalf
        ...
        returns (bool success)
    {
        ...
        require(_value <= allowance[_from][msg.sender]); //check allowance
        balanceOf[_from] -= _value; //Subract from the targeted balance
